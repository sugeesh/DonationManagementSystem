                    ...
                    <div class="box box-primary">
                        ...
                        <form class="form-horizontal" action="application_controller.php" method="post">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-success pull-right" name="back" id="back"><a href="./school_main.php"> Approve Application </a></button>
                                <button type="submit" class="btn btn-danger pull-right" name="donate" id="donate"><a href="./school_main.php"> Reject Application </a></button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
