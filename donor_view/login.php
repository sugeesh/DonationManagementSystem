...
<h3  class="login-box-msg">If you don't have a account, <a href="./register_donor.php" style="color: #00c0ef">Register Here </a></h3>
<br>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <form action="donor_main.php" method="post">
