...
<h3 class="login-box-msg">If you don't have a account, <a href="./register_parent.php" style="color: #00c0ef">Register Today for your Child. </a></h3>
<br>
<h4 class="login-box-msg">If you have a account, Please log in here. </a></h4>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <form action="./parent_home.php" method="post">
